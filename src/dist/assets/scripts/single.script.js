...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _GoogleMapUtils__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./GoogleMapUtils */ "./ux-ui/components/organisms/googleMap/GoogleMapUtils.js");
  ...
  _createClass(GMap, [{
    ...
    value: function newMap(el) {
      ...
      this.markers.forEach(function (x) {
        /* 1 */
        (0,_GoogleMapUtils__WEBPACK_IMPORTED_MODULE_0__.addMarker)(x, _this.map);
      });
      (0,_GoogleMapUtils__WEBPACK_IMPORTED_MODULE_0__.centerMap)(this.map);
      /* 2 */
    }
  }, {
    key: "init",
